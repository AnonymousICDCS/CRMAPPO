...
class PPO(object):
    ...
    def train(self):
        ...
        for _ in range(self.K_epochs):
            ...
            s, a_r, a_f, a_p, td_target_r, adv_r, old_prob_r, = \
                s[perm].clone(), a_r[perm].clone(), a_f[perm].clone(), a_p[perm].clone(), td_target_r[perm].clone(),\
                adv_r[perm].clone(), old_prob_r[perm].clone()
            ...
            for i in range(c_optim_iter_num):
                ...
                # (bs,r_dim)
                c_loss = (self.critic(s[index]) - td_target_r[index]).pow(2).mean()
                value_loss += c_loss
        ...
        return policy_r_loss, 0, 0, value_loss, reward_d_loss, 0
